...
class SignInActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        signInBinding.btnSignup.setOnClickListener(this)
    }

    override fun onClick(v: View) {
        when(v.id){
            R.id.tv_forgot -> startActivity(ForgotPassword.getLaunchService(this))
    ...
    private fun loginEmailPass() {
       val email = signInBinding.etName.text.toString()
       val password = signInBinding.etPass.text.toString()
